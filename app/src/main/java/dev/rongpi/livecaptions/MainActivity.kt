                ...
                Scaffold(
                    ...
                    Column(
                        ...
                        Button(
                            ...
                            modifier = Modifier.fillMaxWidth(),
                            enabled = sttEngine.value.state.value is SttState.Ready && (transState == null || transState.value is TranslationState.Ready)
                        ) {
                        ...
                        Button(
                            ...
                            modifier = Modifier.fillMaxWidth(),
                            colors = ButtonDefaults.buttonColors(containerColor = MaterialTheme.colorScheme.error),
                            enabled = sttEngine.value.state.value !is SttState.Uninitialized && sttEngine.value.state.value !is SttState.Ready
                        ) {
    ...
    private fun SttConfigCard(selectedStt: String, onSttSelected: (String) -> Unit, engine: SttEngine) {
        ...
        ElevatedCard(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                if (sttEngine.value.state.value is SttState.Downloading) {
